...
async def _(event):
    ...
    packname = f"@NoPVs's @NoPVs Pack"
    packshortname = f"Rk{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"@NoPVs"Animation
        packshortname = f"NoPVs Animated"  # format: uni_borg_u
